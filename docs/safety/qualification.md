...
| SC-026 | partial remediation | safety/17-panic-contract: explicit panic policy; AsyncPool enqueue closure is typed; Kani/Verus execution-mode proofs; Lazy/Freer/convenience surfaces remain |
