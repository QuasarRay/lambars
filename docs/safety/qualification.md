...
| SC-026 | partial remediation | safety/17-panic-contract: explicit panic policy; AsyncPool enqueue closure is typed; Kani/Verus execution-mode proofs; Lazy and ConcurrentLazy result paths fixed; partial force/force_mut, Freer, and convenience surfaces remain |
