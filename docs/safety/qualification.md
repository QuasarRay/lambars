...
| SC-026 | partial remediation | safety/17-panic-contract: explicit panic policy; AsyncPool enqueue closure is typed; Kani/Verus execution-mode proofs; Lazy and ConcurrentLazy result paths fixed; ConcurrentLazy force and algebraic-effect invariant remain; Lazy/Freer/AsyncPool primary surfaces are typed |
