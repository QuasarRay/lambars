...
| SC-026 | partial remediation | safety/17-panic-contract: explicit panic policy; AsyncPool enqueue closure is typed; Kani/Verus execution-mode proofs; Lazy try_force/into_inner fixed; Lazy force/force_mut, Freer, and convenience surfaces remain |
